"""Unit tests for RandomForestModel following the ZOMBIES pattern."""
...
def model() -> RandomForestModel:
    """Provides a fresh RandomForestModel instance."""
...
def test_zero_samples(model: RandomForestModel) -> None:
...
def test_one_sample(model: RandomForestModel) -> None:
...
def test_many_samples(model: RandomForestModel) -> None:
...
def test_boundary_features(model: RandomForestModel) -> None:
...
def test_exception_invalid_features(model: RandomForestModel) -> None:
...
def test_simple_happy_path(model: RandomForestModel) -> None:
